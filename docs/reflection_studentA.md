...
Collabrative work was a positive experience overall. We came together in Week 1 to align on the dataset choice, how to split the three location groups, and our individual modeling responsibilities. From there we each worked independently on our assigned sections before coming back together to review each other's work and talk through our findings. The process felt well-balanced and collaborative throughout.
